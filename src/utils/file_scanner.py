...
def scan_directory(data_dir: str, supported_extensions: list[str]) -> dict[str, list[str]]:
    """
    Рекурсивно сканирует указанную директорию и группирует найденные пути файлов по расширениям.
    ...
    for ext in supported_extensions:
        ...
        file_paths = sorted(glob.glob(search_path, recursive=True))  # Результат - список полных путей
