# Документация проекта «Гибридная RAG»

## Обзор структуры документации

Эта директория содержит техническую документацию проекта «Гибридная RAG».
...
| Документ | Описание |
|----------|----------|
| [docs/05_adr_log.md](./05_adr_log.md) | Журнал архитектурных решений (ADR) |
...
| [test_plan.md](./test_plan.md) | План испытаний прототипа: что и как измеряем — уровни метрик, артефакты прогона, режимы запуска, границы измерения |
