...
3. **Инварианты не конфигурируются** через namespace — это не runtime-значения.
   ...
   настраиваются, но семантика отношения (авто/LLM/никогда, порядок вытеснения,
   обязательность projection) зафиксирована инвариантом.
