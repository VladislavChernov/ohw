...
| [dz4](dz4/) | Enterprise GraphRAG-платформа (граф Neo4j + векторный поиск + LLM): Config/Glossary/Ingestion/Query сервисы, прототип вех M0–M4 | M0–M2 реализованы; демо-контур UI `:8503` + e2e-харнесс ([user guide](dz4/docs/demo_user_guide.md), [runbook](dz4/docs/demo_runbook.md)) |
