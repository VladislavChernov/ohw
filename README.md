...
| [dz3](dz3/) | Генератор API-автотестов через LLM: simple — pytest-код; advanced — JSON-план + своё детерминированное ядро | simple — реализовано; advanced — pre-alpha (E2E не прогонялась) |
